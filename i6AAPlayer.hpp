		...
		class ACE_SelfActions
		{
			class l6AA_Medical
				...
				class l6AA_open_ifak
				{
					...
					statement="_player call FUNC(open_IFAK)";
				...
				class l6AA_open_ifak2 : l6AA_open_ifak
				{
					...
					statement="_player call FUNC(open_IFAK2)";
					icon="\z\l6AA\addons\medkits\data\ifak_interaction.paa";
				};
				class l6AA_open_Surgery : l6AA_open_ifak
				{
					...
					statement="_player call FUNC(open_Surgery)";
					icon="\z\l6AA\addons\medkits\data\ifak_interaction.paa";
				};
				class l6AA_open_Transfusion : l6AA_open_ifak
				{
					...
					statement="_player call FUNC(open_Transfusion)";
					icon="\z\l6AA\addons\medkits\data\ifak_interaction.paa";
				};
				class l6AA_open_MASCAS : l6AA_open_ifak
				{
					...
					statement="_player call FUNC(open_MASCAS)";
				...
				class l6AA_open_DRUGS : l6AA_open_ifak
				{
					...
					statement="_player call FUNC(open_DRUGS)";
					icon="\z\l6AA\addons\medkits\data\ifak_interaction.paa";
				};
				class l6AA_open_DRUGS2 : l6AA_open_ifak
				{
					...
					statement="_player call FUNC(open_DRUGS2)";
					icon="\z\l6AA\addons\medkits\data\ifak_interaction.paa";
				};
				class l6AA_open_CONSUMABLES : l6AA_open_ifak
				{
					...
					statement="_player call FUNC(open_CONSUMABLES)";
					icon="\z\l6AA\addons\medkits\data\ifak_interaction.paa";
				};
				class l6AA_open_CONSUMABLES2 : l6AA_open_ifak
				{
					...
					statement="_player call FUNC(open_CONSUMABLES2)";
					icon="\z\l6AA\addons\medkits\data\ifak_interaction.paa";
				};
				class l6AA_open_BANDAGES : l6AA_open_ifak
				{
					...
					statement="_player call FUNC(open_BANDAGES)";
					icon="\z\l6AA\addons\medkits\data\ifak_interaction.paa";
				};
				class l6AA_open_CAP : l6AA_open_ifak
				{
					...
					statement="_player call FUNC(open_CAP)";
					icon="\z\l6AA\addons\medkits\data\ifak_interaction.paa";
				};
			};
		};

	...
	class CAManBase: Man
	{
			...
			class l6AA_Medical
				{
					...
					icon="\l6AA_medkits\data\ifak_interaction.paa";
					exceptions[]=
					{
							"isNotSitting"
					};
				class l6AA_open_ifak
				{
					...
					icon="\l6AA_medkits\data\Medic_Pouch.paa";
					exceptions[]=
					{
							"isNotSitting"
					};
				...
				class l6AA_open_MASCAS : l6AA_open_ifak
				{
					...
					icon="\l6AA_medkits\data\MASCAS.paa";
				};
		...
		class ACE_Actions
		{
			class ACE_MainActions
			{
				...
				icon="\l6AA_medkits\data\basicTrauma.paa";
				};
			};
		};
	};
